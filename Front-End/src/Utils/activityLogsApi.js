...
const BACKEND_ACTIVITY_LOG_TYPES = new Set([
  ...
  ACTIVITY_LOG_TYPES.DASHBOARD_ADDED,
  ACTIVITY_LOG_TYPES.DASHBOARD_UPDATED,
  ACTIVITY_LOG_TYPES.DASHBOARD_REMOVED,
  ACTIVITY_LOG_TYPES.WIDGET_ADDED,
  ACTIVITY_LOG_TYPES.WIDGET_UPDATED,
  ACTIVITY_LOG_TYPES.WIDGET_REMOVED,
])
